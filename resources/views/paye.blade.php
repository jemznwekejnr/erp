		       ...
		       <div class="col-12 col-lg-12">
				...
				<div class="card-header">
					<div class="d-flex align-items-center">
						<div>
							<h4 class="mb-0">Add New PAYE Level</h4>
						</div>
					</div>
				</div>
				  <div class="card-body">
				  	<div class="form-body">
					 <form class="row g-2" method="POST" action="submitpaye" id="submitpaye">
					 	@csrf
					 	<div class="row">
					 	<div class="col-sm-3">
					 		<input type="hidden" name="payeid" id="payeid" value="">
					 	...
					 	<div class="col-sm-3">
					 		<select name="percenatage" id="percenatage" class="form-control" required>
